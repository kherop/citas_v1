        ...
        <div class="container justify-content-center">
            <section class="row">
                <article class="col login bg-red border-radius">
                    <!-- Logo formulario -->
                    <div>
                        <h1 class="display-3 text-white">Ya queda poco...</h1>
                        <p class="text-white">...uno de nuestros adminitradores evaluara tu pedición y activara tu cuenta lo antes posibles, muchas gracias por tu paciencia.</p>
                    </div>
                    <hr class="hr-white">
